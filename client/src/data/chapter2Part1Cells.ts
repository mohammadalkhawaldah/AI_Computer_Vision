import { codeCell, textCell, type LessonCell } from "@/data/lessonSchema";

export const chapter2Part1VideoId = "oaIPQkKR9RU";

export const chapter2Part1Cells: LessonCell[] = [
  textCell(
    "lesson-5-text-1",
